---
title: "How to use Docker to build Application"
layout: post
...
blog: true
author: Topaz
summary: "Dockerfile, docker-compose.yml, Common command, Key Context."
permalink: shell-scripts-en
---
<h1 class="title"> How to use Docker to build Application </h1>
